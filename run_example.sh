...
./stratified_classification_methods.py -i data/tesla_p100_attempts.csv -v -m attempts | tee data/p100_concurrency_verbose_metrics.txt
./stratified_classification_methods.py -i data/tesla_p100_CE.csv -v -m ce | tee data/p100_interference_verbose_metrics.txt