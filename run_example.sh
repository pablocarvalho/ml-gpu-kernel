...
./stratified_classification_methods.py -i data/rtx-2080_attempts.csv -v -g -m attempts 2>&1 | tee data/rtx-2080_concurrency_verbose_metrics_grid.txt
./stratified_classification_methods.py -i data/rtx-2080_CE.csv -v -g -m ce 2>&1 | tee data/rtx-2080_interference_verbose_metrics_grid.txt

#Execution model for tesla p100 data with metrics output and grid-search
./stratified_classification_methods.py -i data/tesla_p100_attempts.csv -v -g -m attempts 2>&1 | tee data/p100_concurrency_verbose_metrics_grid.txt
./stratified_classification_methods.py -i data/tesla_p100_CE.csv -v -g -m ce 2>&1 | tee data/p100_interference_verbose_metrics_grid.txt